...
desc <- "Samples were collected from patients, and bacterial isolates were cultured and identified. Isolates were then sequenced in parallel with undergoing phenotypic AST."
shortname <- "fig:r21cartoon"
where <- "[!ht]"
...
desc <- "Drug resistances can arise through acquisition of a protective gene, such a {\\textbeta}-lactamase gene. Mutations to a drug target such as the \\textit{gyrA} topoisomerase gene can also reduce the effectiveness of antimicrobial agents."
shortname <- "fig:rescartoons"
where <- "[!ht]"

figstr <- paste0('\\begin{', what ,'}', where ,'
\\centering
\\includegraphics[width = .81\\linewidth,keepaspectratio]{figure/', figname, '.pdf}
\\caption[', title ,']{{\\bf ', title  ,'.} ', desc ,' }
\\label{', shortname ,'}
\\end{', what ,'}
')
...
what <- "figure"
figname <- "pipeline"
title <- "Sequencing analysis pipeline"
desc <- "Sequencing reads can be searched in real-time for resistance genes. To detect and assess point mutations, genomes are assembled, and then can be polished using native electrical data (Nanopolish), or highly accurate short-read data (Pilon)."
shortname <- "fig:pipeline"
where <- "[!ht]"
...
desc <- "Summary of nanopore sequencing data for each isolate"
shortname <- "tab:runnanopore"
where <- "[!ht]"

figstr <- paste0('\\begin{', what ,'}', where ,'
\\centering
\\includegraphics[width = .7\\linewidth,keepaspectratio]{figure/', figname, '.pdf}
\\caption[', title ,']{{\\bf ', title  ,'.} ', desc ,' }
\\label{', shortname ,'}
\\end{', what ,'}
')
...
what <- "table"
figname <- "runillumina"
title <- "Illumina sequencing data"
desc <- "Summary of Illumina sequencing data for each isolate"
shortname <- "tab:runillumina"
where <- "[!ht]"
...
what <- "figure"
figname <- "graphsasm"
title <- "Assembly graphs"
desc <- "Representative assembly graphs when using only short reads and only long reads. Short reads are difficult to use for resolving repetitive regions, resulting in bubbles in the graph, whereas assemblies from long read data typically result in a full length bacterial chromosome."
shortname <- "fig:graphsasm"
where <- "[!ht]"
...
what <- "table"
figname <- "asmraw"
title <- "Raw assembly statistics"
desc <- "Summary statistics for genome assemblies of all isolates with no further correction"
shortname <- "tab:asmraw"
where <- "[!ht]"
...
what <- "table"
figname <- "asmpolished"
title <- "Polished assembly statistics"
desc <- "Summary statistics for genome assemblies of all isolates after correction with nanopolish"
shortname <- "tab:asmpolished"
where <- "[!ht]"
...
what <- "table"
figname <- "asmpilon"
title <- "Short-read correction assembly statistics"
desc <- "Summary statistics for genome assemblies of all isolates after correction with short-read data"
shortname <- "tab:asmpilon"
where <- "[!ht]"
...
what <- "table"
figname <- "asmrapid"
title <- "Rapid assembly statistics"
desc <- "Summary statistics for genome assemblies of all isolates using downsampled data"
...
what <- "figure"
figname <- "tree"
title <- "Phylogenetic tree of \\textit{K. pneumoniae} genomes"
desc <- "Isolates from this study are shown in red, and chromosome-level genomes obtained from GenBank are shown in black."
shortname <- "fig:tree"
where <- "[!ht]"

figstr <- paste0('\\begin{', what ,'}', where ,'
\\centering
\\includegraphics[width = .9\\linewidth,keepaspectratio]{figure/', figname, '.pdf}
\\caption[', title ,']{{\\bf ', title  ,'.} ', desc ,' }
\\label{', shortname ,'}
\\end{', what ,'}
')
...
<<results = 'asis', eval = TRUE>>=
what <- "table"
figname <- "astagreement"
title <- "WGS vs phenotypic AST"
desc <- "Percent agreement between three different sequencing and analysis approaches compared to phenotypic antimicrobial susceptibility testing results for 40 \\textit{Klebsiella pneumoniae} clinical isolates"
shortname <- "tab:astagreement"
where <- "[!ht]"
