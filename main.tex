...
\include{amr_chapter/amr_chapter}
\cleardoublepage
\printbibliography[title={References}]
\end{refsection}
...
\include{nivar_chapter/nivar_chapter}
\cleardoublepage
\printbibliography[title={References}]
\end{refsection}

\graphicspath{{mdr_chapter/figure/}{mdr_chapter/}}
\begin{refsection}[mdr_chapter/mdr_chapter.bib]
\include{mdr_chapter/mdr_chapter}
\cleardoublepage
\printbibliography[title={References}]
\end{refsection}
...
\includepdf[pages={-}, pagecommand={}]{YunfanFan_CV.pdf} %continue page numbering through CV
